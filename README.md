...
3. Creator 分别自由创作并发布 Initial App（V0）；测试或正式总流程开始前，Creator 可以删除自己的 V0 并重新创建。
...
6. Creator 试玩、修改并发布 Community Version；Initial Version 始终保留。
7. 正式实验前，Host 可以永久清除测试角色的全部数据，包括测试作品、版本、互动和开发记录；正式角色数据不受影响。
