...
export const communityGalleryApi = {
  ...
  uploadCommunityVersion: (clientId: string, appId: string, code: string, filename: string) =>
    request(`/api/community-gallery/apps/${appId}/upload-community-version`, {
      method: 'POST',
      body: body({ clientId, code, filename }),
    }),
  ...
  rollbackLatestCommunityVersion: (clientId: string, appId: string) =>
    request(`/api/community-gallery/apps/${appId}/rollback-latest-community-version`, {
      method: 'POST',
      body: body({ clientId }),
    }),
